          ...
          <div className="d-flex justify-content-center align-items-center gap-5 mb-4 flag-profile-wrapper">
            <div className="d-flex flex-column align-items-center gap-2">
              ...
              <div className="rounded-circle profile-pic-placeholder shadow-sm position-relative overflow-hidden bg-light" style={{ width: '140px', height: '140px' }}>
                <img src="/images/Screenshot_20220813-213637_Facebook.jpg" alt="Profile photo of Vašek" className="rounded-circle position-absolute top-0 start-0" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
              </div>
            </div>
            ...
            <div className="d-flex flex-column align-items-center gap-2">
              ...
              />
              <div className="rounded-circle profile-pic-placeholder shadow-sm position-relative overflow-hidden bg-light" style={{ width: '140px', height: '140px' }}>
                <img src="/images/file.enc.jpg" alt="Profile photo of Elvira" className="rounded-circle position-absolute top-0 start-0" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-5">
              <div className="placeholder-stack">
                <div className="photo-slot photo-slot-large">
                  <img src="/images/Screenshot_20250613-190920_WhatsApp.jpg" alt="Portrait of Vašek" className="rounded shadow-sm" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row g-3">
            <div className="col-md-4">
              <div className="photo-slot photo-slot-gallery">
                <img src="/images/20221227_203328.jpg" alt="Portrait of Vašek" className="rounded shadow-sm" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
              </div>
            </div>
            <div className="col-md-4">
              <div className="photo-slot photo-slot-gallery">
                <img src="/images/IMG-20260701-WA0004.jpg" alt="Portrait of Elvira" className="rounded shadow-sm" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
              </div>
            </div>
            <div className="col-md-4">
              <div className="photo-slot photo-slot-gallery">
                <img src="/images/Screenshot_20251220-095843_Instagram.jpg" alt="Memory photo" className="rounded shadow-sm" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
              </div>
            </div>
          </div>
        </div>
